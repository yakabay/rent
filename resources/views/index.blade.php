            ...
            <div class="row">
                <div class="col-md-8 col-md-offset-2">
                    ...
                    <div class="probootstrap-home-search probootstrap-animate">
                        ...
                        <p class="mb0 text-left"><small>A free HTML5 template by <a href="https://probootstrap.com/">ProBootstrap.com</a> under license <a href="https://probootstrap.com/license">Creative Commons 3.0</a></small> </p>
                    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4">
                <div class="probootstrap-card text-center probootstrap-animate">
                    <div class="probootstrap-card-media svg-sm colored">
                        <img src="img/flaticon/svg/001-prize.svg" class="svg" alt="Free HTML5 Template by ProBootstrap.com">
                    </div>
            ...
            <div class="col-md-4">
                <div class="probootstrap-card text-center probootstrap-animate">
                    <div class="probootstrap-card-media svg-sm colored">
                        <img src="img/flaticon/svg/005-new.svg" class="svg" alt="Free HTML5 Template by ProBootstrap.com">
                    </div>
                    <div class="probootstrap-card-text">
            ...
            <div class="col-md-4">
                <div class="probootstrap-card text-center  probootstrap-animate">
                    <div class="probootstrap-card-media svg-sm colored">
                        <img src="img/flaticon/svg/006-coin.svg" class="svg" alt="Free HTML5 Template by ProBootstrap.com">
                    </div>
                    <div class="probootstrap-card-text">
        ...
        <div class="row probootstrap-gutter10">
            <div class="col-md-6 col-sm-6">
                <a href="#" class="probootstrap-hover-overlay">
                    <img src="img/slider_2.jpg" alt="Free Bootstrap Template by ProBootstrap.com" class="img-responsive">
            ...
            <div class="col-md-4 col-sm-6">
                <a href="#" class="probootstrap-hover-overlay">
                    <img src="img/slider_3.jpg" alt="Free Bootstrap Template by ProBootstrap.com" class="img-responsive">
                    <div class="probootstrap-text-overlay">
                        <h3>Brooklyn</h3>
                        <p>300 Properties</p>
                    </div>
            ...
            <div class="col-md-4 col-sm-6">
                <a href="#" class="probootstrap-hover-overlay">
                    <img src="img/slider_4.jpg" alt="Free Bootstrap Template by ProBootstrap.com" class="img-responsive">
                    <div class="probootstrap-text-overlay">
                        <h3>Chicago</h3>
                        <p>268 Properties</p>
                    </div>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-4 col-sm-6">
                <div class="probootstrap-card probootstrap-listing">
                    <div class="probootstrap-card-media">
                        <img src="img/slider_1.jpg" class="img-responsive" alt="Free HTML5 Template by ProBootstrap.com">
            ...
            <div class="col-md-4 col-sm-6">
                <div class="probootstrap-card probootstrap-listing">
                    <div class="probootstrap-card-media">
                        <img src="img/slider_2.jpg" class="img-responsive" alt="Free HTML5 Template by ProBootstrap.com">
                        <a href="#" class="probootstrap-love"><i class="icon-heart"></i></a>
                    </div>
                    <div class="probootstrap-card-text">
                        <h2 class="probootstrap-card-heading"><a href="#">3 Bed Room Property for Sale</a></h2>
            ...
            <div class="col-md-4 col-sm-6">
                <div class="probootstrap-card probootstrap-listing">
                    <div class="probootstrap-card-media">
                        <img src="img/slider_3.jpg" class="img-responsive" alt="Free HTML5 Template by ProBootstrap.com">
                        <a href="#" class="probootstrap-love"><i class="icon-heart"></i></a>
                    </div>
                    <div class="probootstrap-card-text">
                        <h2 class="probootstrap-card-heading"><a href="#">3 Bed Room Property for Sale</a></h2>
            ...
            <div class="col-md-4 col-sm-6">
                <div class="probootstrap-card probootstrap-listing">
                    <div class="probootstrap-card-media">
                        <img src="img/slider_4.jpg" class="img-responsive" alt="Free HTML5 Template by ProBootstrap.com">
                        <a href="#" class="probootstrap-love"><i class="icon-heart"></i></a>
                    </div>
                    <div class="probootstrap-card-text">
                        <h2 class="probootstrap-card-heading"><a href="#">3 Bed Room Property for Sale</a></h2>
        ...
        <div class="row">
            <div class="col-md-3">
                <div class="probootstrap-card probootstrap-person text-left">
                    <div class="probootstrap-card-media">
                        <img src="img/person_1.jpg" class="img-responsive" alt="Free HTML5 Template by ProBootstrap.com">
                    </div>
                    <div class="probootstrap-card-text">
            ...
            <div class="col-md-3">
                <div class="probootstrap-card probootstrap-person text-left">
                    <div class="probootstrap-card-media">
                        <img src="img/person_2.jpg" class="img-responsive" alt="Free HTML5 Template by ProBootstrap.com">
                    </div>
                    <div class="probootstrap-card-text">
            ...
            <div class="col-md-3">
                <div class="probootstrap-card probootstrap-person text-left">
                    <div class="probootstrap-card-media">
                        <img src="img/person_3.jpg" class="img-responsive" alt="Free HTML5 Template by ProBootstrap.com">
                    </div>
                    <div class="probootstrap-card-text">
            ...
            <div class="col-md-3">
                <div class="probootstrap-card probootstrap-person text-left">
                    <div class="probootstrap-card-media">
                        <img src="img/person_4.jpg" class="img-responsive" alt="Free HTML5 Template by ProBootstrap.com">
                    </div>
                    <div class="probootstrap-card-text">
